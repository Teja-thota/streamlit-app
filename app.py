...
# Ensure YOLOv5 model file exists, otherwise download manually
MODEL_PATH = "yolov5s.pt"
if not os.path.exists(MODEL_PATH):
    st.error("YOLOv5 model file is missing. Please download it manually from:")
    st.markdown("[YOLOv5 Release Page](https://github.com/ultralytics/yolov5/releases/download/v6.0/yolov5s.pt)")
    st.stop()
